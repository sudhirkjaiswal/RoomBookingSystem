...
define(
		...
		[ "../_base/kernel", "../_base/lang", "../_base/declare",
				"../_base/array", "../_base/xhr", "../Evented",
				"./util/filter", "./util/simpleFetch", "../date/stamp" ],
					...
					[ _6 ],
					{
						constructor : function(_b) {
							...
							if (_b.urlPreventCache !== undefined) {
								this.urlPreventCache = _b.urlPreventCache ? true
										: false;
							}
							if (_b.hierarchical !== undefined) {
								this.hierarchical = _b.hierarchical ? true
										: false;
							}
							if (_b.clearOnClose) {
						...
						_containsValue : function(_1d, _1e, _1f, _20) {
							return _4.some(this.getValues(_1d, _1e), function(
									_21) {
						...
						filter : function(_27, _28, _29) {
							var _2a = [], i, key;
							if (_27.query) {
								var _2b, _2c = _27.queryOptions ? _27.queryOptions.ignoreCase
										: false;
								var _2d = {};
								...
								for (i = 0; i < _28.length; ++i) {
									...
									if (_2f === null) {
										...
										for (key in _27.query) {
											_2b = _27.query[key];
											if (!this._containsValue(_2f, key,
													_2b, _2d[key])) {
												_2e = false;
											}
										}
						...
						_fetchItems : function(_31, _32, _33) {
							...
							if (this._loadFinished) {
								this.filter(_31, this
										._getItemsArray(_31.queryOptions), _32);
							} else {
								...
								if (this._jsonFileUrl) {
									if (this._loadInProgress) {
										this._queuedFetches.push({
											args : _31,
											filter : _2.hitch(_34, "filter"),
											findCallback : _2.hitch(_34, _32)
										});
									} else {
										this._loadInProgress = true;
										var _35 = {
											url : _34._jsonFileUrl,
										...
										var _36 = _5.get(_35);
										_36
												.addCallback(function(_37) {
													try {
														_34
																._getItemsFromLoadedData(_37);
														...
														_34
																.filter(
																		_31,
																		_34
																				._getItemsArray(_31.queryOptions),
																		_32);
														_34
								...
								for (var i = 0; i < this._queuedFetches.length; i++) {
									...
									if (_3c) {
										_3c(
												_3b,
												this
														._getItemsArray(_3b.queryOptions),
												_3d);
									} else {
						...
						close : function(_3f) {
							if (this.clearOnClose && this._loadFinished
									&& !this._loadInProgress) {
								if (((this._jsonFileUrl == "" || this._jsonFileUrl == null) && (this.url == "" || this.url == null))
										&& this.data == null) {
								}
								this._arrayOfAllItems = [];
								this._arrayOfTopLevelItems = [];
						...
						_getItemsFromLoadedData : function(_40) {
							...
							function _43(_44) {
								return (_44 !== null)
										...
										&& (!_2.isArray(_44) || _41)
										&& (!_2.isFunction(_44))
										&& (_44.constructor == Object || _2
												.isArray(_44))
										&& (typeof _44._reference === "undefined")
										&& (typeof _44._type === "undefined")
										&& (typeof _44._value === "undefined")
										&& _42.hierarchical;
							}
							;
							function _45(_46) {
											...
											if (("_type" in _4d)
												...
												if (!_52) {
													...
													if (_2.isFunction(_52)) {
														...
														if (_2
																.isFunction(_52.deserialize)) {
															_4e[j] = _52
																	.deserialize(_4d._value);
														} else {
															throw new Error(
							...
							if (!this._loadFinished) {
								...
								if (this._jsonFileUrl) {
									if (this._loadInProgress) {
										...
										var _63 = _5.get(_62);
										_63
												.addCallback(function(_64) {
													var _65 = _5e.scope ? _5e.scope
															: _1.global;
													try {
														_61
																._getItemsFromLoadedData(_64);
														_61._loadFinished = true;
														_61._loadInProgress = false;
														_5f = _61
																._getItemByIdentity(_5e.identity);
														if (_5e.onItem) {
															_5e.onItem.call(
																	_65, _5f);
														}
									...
									if (this._jsonData) {
										_61
												._getItemsFromLoadedData(_61._jsonData);
										_61._jsonData = null;
										_61._loadFinished = true;
										_5f = _61
												._getItemByIdentity(_5e.identity);
										if (_5e.onItem) {
											_60 = _5e.scope ? _5e.scope
													: _1.global;
						...
						_getItemByIdentity : function(_68) {
							...
							if (this._itemsByIdentity) {
								if (Object.hasOwnProperty.call(
										this._itemsByIdentity, _68)) {
									_69 = this._itemsByIdentity[_68];
								}
							} else {
								if (Object.hasOwnProperty.call(
										this._arrayOfAllItems, _68)) {
						...
						_forceLoad : function() {
							...
							if (this._jsonFileUrl) {
								...
								var _6e = _5.get(_6d);
								_6e
										.addCallback(function(_6f) {
											try {
												if (_6c._loadInProgress !== true
														&& !_6c._loadFinished) {
													_6c
															._getItemsFromLoadedData(_6f);
