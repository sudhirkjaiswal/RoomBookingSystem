...
define(
		...
		[ "dojo/_base/declare", "dojo/_base/kernel", "dojo/i18n", "./TextBox",
				"../Tooltip", "dojo/text!./templates/ValidationTextBox.html",
		...
		function(_1, _2, _3, _4, _5, _6) {
			...
			return _7 = _1(
					...
					_4,
					{
						...
						state : "",
						tooltipPosition : [],
						_deprecateRegExp : function(_8, _9) {
						...
						validator : function(_c, _d) {
							return (new RegExp("^(?:"
									+ this._getPatternAttr(_d) + ")"
									+ (this.required ? "" : "?") + "$"))
									.test(_c)
									&& (!this.required || !this._isEmpty(_c))
									&& (this._isEmpty(_c) || this.parse(_c, _d) !== undefined);
						},
						...
						getErrorMessage : function() {
							var _f = this.invalidMessage == "$_unset_$" ? this.messages.invalidMessage
									: !this.invalidMessage ? this.promptMessage
											: this.invalidMessage;
							var _10 = this.missingMessage == "$_unset_$" ? this.messages.missingMessage
									: !this.missingMessage ? _f
											: this.missingMessage;
							return (this.required && this
									._isEmpty(this.textbox.value)) ? _10 : _f;
						},
						...
						validate : function(_11) {
							...
							this
									._set(
											"state",
											_13 ? ""
													: (((((!this._hasBeenBlurred || _11) && _14) || _15) && (this._maskValidSubsetError || (_15
															&& !this._hasBeenBlurred && _11))) ? "Incomplete"
															: "Error"));
							...
							if (this.state == "Error") {
								...
								if (this.state == "Incomplete") {
									...
									this._maskValidSubsetError = !this._hasBeenBlurred
											|| _11;
								} else {
									if (_14) {
										_12 = this.getPromptMessage(_11);
						...
						postMixInProperties : function() {
							this.inherited(arguments);
							this.messages = _3.getLocalization("dijit.form",
									"validate", this.lang);
